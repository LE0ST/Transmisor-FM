...
- **Performance:** Provides a theoretical voltage gain of approximately Av ≈ 49.3 dB at the 9 V design operating point.
...
- **Performance:** Theoretical frequency of 84.116 MHz (CALCULATED), tuned physically to 94.6 MHz (OBSERVED) in the prototype. Theoretical FM sensitivity calculated as kf ≈ 66.08 kHz/V.
...
- **Topology:** Passive Pi LC bandpass filter
- **Performance:** Designed for a theoretical center frequency of f0 = 101.94 MHz and a theoretical bandwidth of 19.89 MHz (CALCULATED), targeting a nominal 50 Ω load match.
...
| Audio voltage gain (Av) | 49.3 dB | CALCULATED at 9 V design point | Analytical Model |
| FM sensitivity (kf) | 66.08 kHz/V | CALCULATED | Analytical Model |
